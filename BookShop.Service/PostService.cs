...
namespace BookShop.Service
{
    ...
    public class PostService : IPostService
    {
        ...
        public IEnumerable<Post> GetAllByCategoryPaging(int IdCategory, int page, int pagesize, out int totalRow)
        {
            return _postRepository.GetMultiPaging(x => x.Status && x.CategoryPostID == IdCategory, out totalRow, page, pagesize, new string[] { "PostCategory" });
        }
